...
def parse_args(mode='train'):
    ...
    parser.add_argument('--asset_dir', default='/opt/ml/p4-dkt-ollehdkt/asset', type=str, help='data directory')
    
    parser.add_argument('--file_name', default='train_data.csv', type=str, help='train file name')
    
    parser.add_argument('--model_dir', default='/opt/ml/p4-dkt-ollehdkt/models/', type=str, help='model directory')
