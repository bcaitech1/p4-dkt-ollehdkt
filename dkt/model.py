...
class LSTM(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.args.n_questions = len(np.load(os.path.join(args.asset_dir,'assessmentItemID_classes.npy')))
        self.args.n_test = len(np.load(os.path.join(args.asset_dir,'testId_classes.npy')))
        self.args.n_tag = len(np.load(os.path.join(args.asset_dir,'KnowledgeTag_classes.npy')))
