...
from .model import BiLSTMATTN, DevLSTMConvATTN, LSTM, LSTMConvATTN, LSTMRobertaATTN, LastQuery_Post, LastQuery_Post_TEST, LastQuery_Pre, MyLSTMConvATTN, TestLSTMConvATTN, Saint
from .model import TfixupSaint
import wandb
...
def run(args, train_data, valid_data):
    ...
    for epoch in range(args.n_epochs):
        ...
        wandb.log({"epoch": epoch, "train_loss": train_loss, "train_auc": train_auc, "train_acc":train_acc,
                  "valid_auc":auc, "valid_acc":acc, "best_auc":best_auc})
        if auc > best_auc:
            best_auc = auc
