...
if __name__ == "__main__":
    test_dir='/opt/ml/code/output/ensemble'#prediction folder path
    print(test_dir, "에 있는 파일을 제출하였습니다")
    # 아래 글을 통해 자신의 key값 찾아 넣기
    # http://boostcamp.stages.ai/competitions/3/discussion/post/110

    # desc = "desc 시도" 
    submit("Bearer 15bdf505e0902975b2e6f578148d22136b2f7717", os.path.join(test_dir, 'prediction.csv'))
